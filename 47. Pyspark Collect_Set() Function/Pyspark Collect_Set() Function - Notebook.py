...
# MAGIC %md
# MAGIC #### Pyspark Collect_Set() Function in Azure Databricks
...
# Note: Look we have no duplication here
...
# Collect the salaries department wise without any duplication
