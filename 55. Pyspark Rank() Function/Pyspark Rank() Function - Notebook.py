...
# MAGIC %md
# MAGIC #### Pyspark Rank() Function in Azure Databricks
...
# MAGIC %md
# MAGIC ##### 1. Ranking each records based on points descendingly
...
# Note: Nico and Kimi scored 5th rank, hence the rank was skipped to 7th for the next person.
...
# Note: Each driver of a team got rank based on high ranks

# COMMAND ----------

# MAGIC %md
# MAGIC ##### 3. Difference between rank() and dense_rank()
...
# Note: Nico and Kimi scored 5th rank, see the follow up fellow receives 6th rank. Because, dense_rank leaves no gap between ranks.