...
# MAGIC %md
# MAGIC #### Pyspark Flatmap() Function in Azure Databricks
...
# MAGIC %md
# MAGIC ##### b) Create PySpark RDD by reading file
...
# MAGIC %md
# MAGIC ##### 1. flatMap() function on RDD
