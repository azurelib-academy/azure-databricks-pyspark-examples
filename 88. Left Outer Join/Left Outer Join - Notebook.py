...
# MAGIC %md
# MAGIC #### Left Outer Join in Azure Databricks
...
# Method 1:
std_df.join(dept_df, std_df.dept_id == dept_df.id, "left").show()

# Method 2:
std_df.join(dept_df, std_df.dept_id == dept_df.id, "leftouter").show()

# Method 3:
std_df.join(dept_df, std_df.dept_id == dept_df.id, "left_outer").show()

# COMMAND ----------

# To avoid duplicate columns:
std_df.join(dept_df.withColumnRenamed("id", "dept_id"), "dept_id", "left").show()
