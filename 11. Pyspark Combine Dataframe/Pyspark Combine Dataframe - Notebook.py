...
# MAGIC %md
# MAGIC #### Pyspark Combine Dataframe in Azure Databricks
...
# MAGIC %md
# MAGIC ##### 1. Combine DataFrame vertically
...
# MAGIC %md
# MAGIC ##### 2. Combine distinct values of Two DataFrames 
...
# MAGIC %md
# MAGIC ##### 3. Combine different DataFrames of un-matched columns
