...
# MAGIC %md
# MAGIC #### Pyspark Datediff() Function in Azure Databricks
...
# MAGIC %md
# MAGIC ##### 1. Difference between two dates using DataFrame
...
# MAGIC %md
# MAGIC ##### 2. Difference between two dates using SQL expression
...
SELECT
    from_date,
    floor(months_between(to_date, from_date)) AS difference,
    to_date
FROM days
""").show()